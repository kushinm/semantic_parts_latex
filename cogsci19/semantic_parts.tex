...
\subsection{How is part imformation emphasized in different communicative contexts?}
...
For example, when trying to communicate about a particular bird (e.g., a nightingale) in a close context containing other, perceptually similar birds, sketchers may select 

...
These results suggest a higher-level compositional structure in the procedure by which people convey semantic information in their sketches: frequently, they use a single stroke to convey an entire part; but when they do use multiple strokes to convey a single part, they tend to draw these in succession before moving on to a different part. 

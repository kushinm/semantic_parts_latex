...
\renewcommand{\@maketitle}{\@oldmaketitle% Update \@maketitle to insert...
 ...
 \captionof{figure}{Drawings of 3D objects produced in communication task. Different stroke colors correspond to different object parts.}\bigskip}% ... an image
\makeatother
...
\kushin{will update this section}
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{figures/stroke_part_relationship.png}
\caption{temp}
\label{figg}
\end{figure}

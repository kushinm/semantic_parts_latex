...
Consistent with this, we found strong correlations between the feature vectors for close and far drawings of the same object ($r = 0.73$,  CI: [0.68, 0.77]), which were significantly stronger than close and far drawings of \emph{different} objects ($r = 0.64$, CI: [0.60,  0.68]; same object vs. different object:  \textit{p}$ < 0.001$).

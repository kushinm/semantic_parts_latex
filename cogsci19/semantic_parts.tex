...
These results suggest that close and far drawings of the same object emphasize part information in similar ways, exceeding that expected due to membership in the same basic-level category (Fig.~\ref{part_emphasis}B). 

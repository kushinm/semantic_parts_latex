...
This shows that the way viewers interpret which part each stroke represents is systematic, providing validation for our general approach. 
...
This result raised the question: to what extent are strokes depicting the same part drawn in succession, or interleaved among strokes corresponding to other parts?
In other words, how does the \emph{temporal sequence} of stroke production relate to semantic part structure?

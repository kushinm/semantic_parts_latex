...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{figures/Part-Stroke.jpeg}
...
\centering
\includegraphics[width=1.\textwidth]{figures/bird_average_parts.png}
\caption{Bird}
\end{subfigure}
 \hfill
\begin{subfigure}[t]{0.2\textwidth}
\centering
\includegraphics[width=1.\textwidth]{figures/car_average_parts.png}
\caption{Car}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.2\textwidth}
...
Larger parts and parts that tend to have multiple instances tend to require multiple strokes.ß
}

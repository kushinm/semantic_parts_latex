...
%% all the more remarkable we can extract these things based purely on considering something like effort cost. future work should link fine-grained semantic knowledge to the perceptual content of each stroke, beyond simple effort cost statistics such as number of strokes and amount of ink expended.

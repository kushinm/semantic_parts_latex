...
This was slightly more common in drawings produced in far contexts (19.4\%, 95 \%CI = 17.9\%, 20.9 \%) than close contexts (17.6\%, 95\% CI : [16.1\%, 18.8\%]).  This indicates that a candidate strategy for creating sparser abstract drawings may be to utilize individual strokes to represent multiple spatially contiguous parts. 
...
The structure of the completed drawing reflects this semantic part knowledge, even when drawings are produced in different contexts to varying degrees of detail. Detailed drawings of objects distinguish themselves from their sparser counterparts by preferentially expressing object-specific parts through their constituent strokes.
...
These findings support the idea of compositionality in abstract visual conceptions of objects and categories. [LAKE ET AL 2017, BIEDERMAN 1987]. 
Such a form of representation is powerful for categorizing novel objects, discerning objects identity through sparse or noisy channels, \kushin{too vague maybe?} and expressing concepts cheaply, as we see in the sparse drawings in our reference game dataset. 
...
Through their drawings, people reveal their compositional knowledge of objects and the relationship between these constituent parts.

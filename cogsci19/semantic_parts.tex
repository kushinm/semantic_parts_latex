...
Humans are capable of leveraging their abstract understanding of objects to equivalently identify them across a variety of modalities — photographs, drawings, 3D renders, sculptures, and real world instances. 
A testament to the flexibility this ability of ours is that even with limited information, as is provided by the sparse sketches that appear in our reference game dataset, we are nevertheless able to perform this task of recognition. This abstract understanding even extends to the realm of graphical production, allowing people to effectively communicate with each other using only a limited number of strokes.

Our results support the idea that this understanding is, in part, facilitated by people's semantic knowledge, namely their knowledge of the compositional nature of category-specific parts. The prevalent one-to-one correspondence between strokes made by the sketcher and part-labels assigned to those strokes by annotators indicates that this abstract knowledge is deployed for graphical production much like it is used for recognition.
This notion is also supported by the fact that sparse and detailed sketches exhibit similar part information with detailed sketches emphasizing certain parts over others. This flexibility of expression across varied communicative contexts is a powerful aspect of part-based representations,

While our findings show that people's semantic knowledge of parts may influence how they recognize and produce sketches,\kushin{ TBC.. Bridging the gap between SOTA vision models and human-like semantic representations}

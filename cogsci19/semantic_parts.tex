...
Because our goal was to characterize how semantic structure manifests during drawing production, it was important to encode each drawing instead using a vector image format that preserves this sequential and contour information (i.e., \texttt{*.svg}). 

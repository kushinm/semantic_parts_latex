...
\jefan{I recommend using the same language from the abstract where we enumerate the main findings, preserving the sequence in which those findings appear in the paper.}

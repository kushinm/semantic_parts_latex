...
\textit{second}, we explore the link between this structure and the temporal dynamics of drawing production,
...
Towards this goal, we developed a web-based platform \cite{deLeeuw2015} to collect dense semantic annotations of the stroke elements in drawings of real-world objects.

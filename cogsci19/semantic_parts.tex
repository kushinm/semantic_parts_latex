...
Humans are able to leveraging their abstract understanding of objects to equivalently recognize them across a variety of modalities — photographs, 3D renders, sculptures, and real world instances. We posit that a testament to the flexibility of this ability is that even with limited information, as is provided by the sparse sketches in our reference game dataset, we are nevertheless deftly able to perform this task of recognition. This abstract understanding even extends to the realm of graphical production, allowing people to effectively communicate with each other using only a limited number of strokes on a canvas.

...
\subsection{Reference game dataset}
...
\subsection{Semantic annotation procedure}
...
Similar to , sub-strokes are parameterized as cubic spline curve segments \cite{lake2015human}

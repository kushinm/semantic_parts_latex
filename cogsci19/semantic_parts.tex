...
Humans are capable of leveraging their abstract understanding of objects to equivalently identify them across a variety of modalities — photographs, 3D renders, sculptures, and real world instances. 
A testament to the flexibility this ability of ours is that even with limited information, as is provided by the sparse sketches that appear in our reference game dataset, we are nevertheless deftly able to perform this task of recognition. This abstract understanding even extends to the realm of graphical production, allowing people to effectively communicate with each other using only a limited number of strokes on a canvas.

Our results support the idea that this understanding is, in part, facilitated by people's semantic knowledge, namely their knowledge of the compositional nature of category-specific parts. The prevalent one-to-one correspondences between strokes made by the sketcher and part-labels assigned to those strokes by annotators indicate that this abstract knowledge is deployed for both graphical production and recognition.
This notion is also supported by the fact that sparse and detailed sketches exhibit similar part information with detailed sketches emphasizing certain diagnostic parts over others. This flexibility of expression across varied communicative contexts is a powerful aspect of part-based representations.

While our findings show that people's semantic knowledge of parts may influence how they recognize and produce sketches, we believe our current part-feature characterization to be an overly explicit instantiation of semantics in communicative sketches. Though we believe such approximations are beneficial to showing how semantically meaningful information is expressed by sequences of strokes and perceived by humans in a flexible manner, we are still shy of being able to translate the high dimensional feature spaces in modern vision models to more human-like perceptual representations through this approach alone. Future work will seek to integrate these two approaches.

...
We found that: (1) people are consistent in what they interpret individual strokes to represent; (2) that single strokes tend to correspond to single parts, with strokes representing the same part often being clustered in time; and (3) that both sparse and detailed drawings of the same object emphasize similar part information, although detailed drawings of different objects are more distinct from one another than sparse drawings. 

...
\kushin{We found that: (1) people are consistent in what they interpret individual strokes to represent. (2) Single strokes tend to correspond to single parts with (3) strokes representing the same part often being clustered in time. (4) Both sparse and detailed drawings of the same object emphasize similar part information with (5) detailed drawings of different objects are more distinct from one another than sparse drawings}. 

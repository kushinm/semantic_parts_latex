...
How are our visual object concepts organized such that we can both recognize these abstract correspondences and also exploit them when deciding which strokes to draw?
...
To evaluate this hypothesis, we developed a web-based platform to densely annotate drawings of real-world objects with part information.% that varied in how detailed they were.  
Our corpus of drawings contained both highly detailed and sparser drawings produced in different communicative contexts.
